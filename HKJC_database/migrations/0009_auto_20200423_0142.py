# Generated by Django 3.0.3 on 2020-04-22 17:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('HKJC_database', '0008_delete_jockey'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jockey', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='HKJC_database.Jockey_Info')),
            ],
            options={
                'ordering': ['number_win'],
            },
