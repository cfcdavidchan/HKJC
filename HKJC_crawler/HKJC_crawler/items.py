...
from HKJC_database.models import RacingCourse, Jockey_Info, Jockey_Report, Trainer_Info, Trainer_Report, Horse_Info, Horse_Report, Horse_Ranking, Match_Info, Match_Result, Draw_statistics
...
class DrawstatisticsItem(DjangoItem):
    django_model = Draw_statistics
    pass